...
urlpatterns = [
    ...
    path('add_agree/', views.add_agree, name='add_agree'),  # Добавить согласие в поручением депутату в TasksRating
    path('delete_agree/', views.delete_agree, name='delete_agree'), # Удалить согласие в поручением депутат
